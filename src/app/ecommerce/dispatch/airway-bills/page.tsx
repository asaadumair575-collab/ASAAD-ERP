  ...
  return (
    <div className="max-w-2xl space-y-6 pb-8">
      ...
      <form
        ...
        method="GET"
        target="_blank"
        className="bg-white border border-gray-200 rounded-2xl shadow-sm px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3"
      >
        <input
          type="date"
          name="date"
        ...
        <button
          type="submit"
          className="sm:ml-auto bg-white border border-[#16202E] text-[#16202E] text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 w-full sm:w-auto"
        >
