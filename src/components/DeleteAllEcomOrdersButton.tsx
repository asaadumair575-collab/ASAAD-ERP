    ...
    <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-3">
      ...
      >
        <input
          ...
          className="flex-1 bg-white border border-red-300 rounded-lg px-3 py-2.5 sm:py-2 text-base sm:text-sm font-mono focus:outline-none focus:ring-2 focus:ring-red-500"
        />
        <div className="flex gap-2">
          <button
            type="submit"
            disabled={confirmation !== CONFIRM_TEXT || pending}
            className="flex-1 sm:flex-none bg-red-600 text-white text-sm font-medium px-4 py-2.5 sm:py-2 rounded-lg hover:bg-red-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            className="text-sm text-gray-500 hover:text-gray-700 px-3 py-2.5 sm:py-2"
          >
            Cancel
          </button>
        </div>
