          ...
          <>
            ...
            {openSection === "leads" && (
              <div className="ml-4 pl-3 border-l border-white/10 space-y-0.5 py-0.5">
                ...
                {canViewSub(permissions, "leads_deal_in_process", isAdmin) && (
                  <NavLink href="/leads/deal-in-process" active={pathname.startsWith("/leads/deal-in-process")} compact onClick={closeMobile}>Deal in Process</NavLink>
                )}
