...
export const SUB_MODULES = [
  ...
  // Ecommerce
  { parentKey: "ecommerce",   key: "ecom_all_dashboard",         label: "All Dashboard"         },
  ...
  { parentKey: "ecommerce",   key: "ecom_book_postex",           label: "Book on Postex"        },
  { parentKey: "ecommerce",   key: "ecom_generate_dispatch",     label: "Generate Dispatch List"},
  { parentKey: "ecommerce",   key: "ecom_print_labels",          label: "Print Labels"          },
